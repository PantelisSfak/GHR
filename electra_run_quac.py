...
def main():
    ...
    #Freeze all the non-adapter layers
    for name, param in list(model.named_parameters()):
        name_split=name.split(".")
        if "adapters" not in name_split and "electralayer" not in name_split and "electra" in name_split and (name != "electra.encoder.pe.weight" and name != "electra.encoder.LayerNorm.weight" and name != "electra.encoder.LayerNorm.bias"):
